function carregar(){
  ...
  if (horas>4 && horas<12) {
    ...
    imagem.src = "./sources/pexels-aliaksei-semirski-14458378.jpg";
    ...
    imagem.src = "./sources/pexels-eberhard-grossgasteiger-2098427.jpg";
    window.document.body.style.background = "#222E3C";
  }else{
    // BOA TARDE!
    imagem.src = "./sources/pexels-thuong-d-12810433.jpg";
